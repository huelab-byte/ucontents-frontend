  ...
  return (
    <AdminDashboardLayout>
      <div className="space-y-6">
        {/* Header */}
        <div>
          <h1 className="text-3xl font-bold">Video Overlays Library</h1>
          <p className="text-muted-foreground mt-2">
            Motion-based visual elements layered on top of videos to enhance depth, mood, and cinematic quality without altering the original footage.
          </p>
        </div>
                  ...
                  <tbody>
                    {currentLibraries.map((library) => (
                      <tr
                        ...
                        onClick={() => router.push(`/admin/footage-library/video-overlays/${library.id}`)}
                      >
          ...
          <Card className="p-12 text-center">
            <CardContent className="pt-6">
              ...
              <p className="text-muted-foreground mb-4">
                Create your first library to organize your video overlays.
              </p>
              <NewLibraryDialog onCreate={handleCreateLibrary} />
            </CardContent>
          </Card>
