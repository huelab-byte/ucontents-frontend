          ...
          <table className="w-full border-collapse">
            <thead className="border-b border-border">
              <tr>
                ...
                <th className="text-left text-sm font-medium text-muted-foreground px-4 py-3">Horizontal</th>
                <th className="text-left text-sm font-medium text-muted-foreground px-4 py-3">Vertical</th>
                <th className="text-left text-sm font-medium text-muted-foreground px-4 py-3">Total Clips</th>
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-sm">
                      {(library.horizontal_count ?? 0).toLocaleString()}
                    </td>
                    <td className="px-4 py-3 text-sm">
                      {(library.vertical_count ?? 0).toLocaleString()}
                    </td>
                    <td className="px-4 py-3 text-sm">
                      {(library.footage_count ?? 0).toLocaleString()}
                    </td>
                    <td className="px-4 py-3">
