    ...
    return (
      <Card className="mr-0 sm:mr-[26px] p-12 text-center">
        <CardContent className="pt-6">
          ...
          <h3 className="text-lg font-semibold mb-2">No image overlay files yet</h3>
          <p className="text-muted-foreground mb-4">Upload your first image overlay file to get started. (PNG, GIF, or WebP only)</p>
        </CardContent>
      </Card>
    )
  }
