 ...
 * Admin users use /admin/support/{id}, customers use /support/tickets/{id}.
 */
...
function HeaderContent() {
  ...
  const handleNotificationClick = React.useCallback((recipient: NotificationRecipient) => {
    const url = getNotificationUrl(recipient, true) // Admin dashboard
            ...
            {isLoading ? (
              ...
              <div className="p-2">
                {notifications.map((recipient) => {
                  ...
                  const hasUrl = !!getNotificationUrl(recipient, true)
