...
interface BulkPostingTableProps {
    ...
    return (
      <Card className="p-12 text-center">
        <CardContent className="pt-6">
          <CardTitle className="mb-2">No bulk posting campaigns yet</CardTitle>
        ...
        {totalPages > 1 && (
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 py-4 border-t border-border mt-4">
            <div className="text-sm text-muted-foreground whitespace-nowrap">
              Showing {(startIndex + 1).toLocaleString()} to {Math.min(endIndex, items.length).toLocaleString()} of {items.length.toLocaleString()} campaigns
            </div>
